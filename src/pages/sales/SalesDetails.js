...
export default function SalesDetails() {
    ...
    const viewAdditionalFields = async () => {
        const res = await axios.get(`${'http://62.72.57.19:5000'}/api/sales/viewOptionalFields/${id}`,
            addFields
        );
    ...
    const addOptionalFields = async () => {
        await axios.post(`${'http://62.72.57.19:5000'}/api/sales/addFields/${id}`,
            optionalFields
        );
    ...
    const saveDeductions = async () => {
        ...
        await axios.post(`${'http://62.72.57.19:5000'}/api/sales/salesVoucherDeductions/${id}`, body).then(res => console.log(res));
    ...
    const saveUpdateVoucher = (id) => {
        ...
        axios.put(`${'http://62.72.57.19:5000'}/api/voucher/addVoucherAdditionalData/${voucherId}`, voucher)
    ...
    const getVouchers = async () => {
        const res = await axios.get(`${'http://62.72.57.19:5000'}/api/voucher/viewVoucherDetails/${1}`);
    ...
    const savePurchase = (id) => {
        ...
        axios.post(`${'http://62.72.57.19:5000'}/api/voucher/addVoucherDetails/${1}`, newVoucherData).then(res => console.log("my res", res));
    ...
    useEffect(() => {
        axios.get(`${'http://62.72.57.19:5000'}/api/sales/${id}`)
            // .then(res => res.json())
            .then(res => {
